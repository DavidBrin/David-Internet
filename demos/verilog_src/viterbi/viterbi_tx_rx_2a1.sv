module viterbi_tx_rx #(
   ...
   // Written as explicit 1-bit values: Icarus Verilog keeps an overridden `parameter bit`
   // 32 bits wide, so {ERR_BIT1, ERR_BIT0} silently became {32'd1, 32'd0} = 2'b00 and the
   // bit[1] presets injected nothing. (Found by the bit-exactness test, 2026-08-30.)
   assign err_mask = {ERR_BIT1 ? 1'b1 : 1'b0, ERR_BIT0 ? 1'b1 : 1'b0};
