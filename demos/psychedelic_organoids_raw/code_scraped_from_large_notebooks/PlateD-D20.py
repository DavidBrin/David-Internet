# Code scraped from PlateD/PlateD-D20.ipynb (18 MB notebook; outputs dropped)

# %% [cell 1]
'''
Description
Author: David Brin
Date created 10/9/24
...
# %% [cell 3]
lfp_data = load_lfp(r"C:\Users\david\Documents\Voytek Research\LFP_psych_proj\PlateD\d20\lfp_data.h5")
spike_times = load_spikes(r"C:\Users\david\Documents\Voytek Research\LFP_psych_proj\PlateD\d20\spike_data.mat")
...
# %% [cell 20]
 plot_peak_boxplot2(fm_array, dose_grid)
