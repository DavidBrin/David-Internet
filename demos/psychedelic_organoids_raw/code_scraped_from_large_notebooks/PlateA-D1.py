# Code scraped from PlateA/PlateA-D1.ipynb (3 MB notebook; outputs dropped)
...
# %% [cell 3]
lfp_data = load_lfp(r"C:\Users\david\Documents\Voytek Research\LFP_psych_proj\PlateA\PlateA_D1\poststim_lfp_data.h5")
