...
const site: SiteManifest = {
  ...
  deepLinks: [
    ...
    },
    {
      ...
      snippet:
        "The original 2020 programs running live: the Wall Maze solved by eye sensors, the perimeter octagon drawn pen-down, the dance, the random drive, and the Python Art Canvas - block listing highlighting in step, arrow-key drive mode included.",
