  ...
  deepLinks: [
    {
      ...
      snippet:
        "Pick a database, see its tables and foreign-key graph drawn live, hover a table to highlight its DDL - beside the hand-drawn meeting-room and news-broadcast ER designs and the bike-shop data sheet.",
