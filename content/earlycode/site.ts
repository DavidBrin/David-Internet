...
const site: SiteManifest = {
  ...
  deepLinks: [
    ...
    },
    {
      ...
      snippet:
        "The trie grows node by node, failure links attach in BFS order, and a cursor walks your text emitting (end, pattern) tuples. 106 nodes, the same count the notebook's library call reported.",
