...
const site: SiteManifest = {
  ...
  deepLinks: [
    ...
    },
    {
      ...
      snippet:
        "Committed notebook outputs for subject B: window-classification accuracy for CNN1-3 and the MCNN ensembles, and character accuracy climbing 37% to 94% over 15 repetitions, plus the actual 100-letter test sentence it spelled.",
