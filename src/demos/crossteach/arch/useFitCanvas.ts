...
/**
 * DPR-aware square-canvas sizing hook local to the #architectures panel
 * (kept self-contained rather than importing the training panel's copy).
 ...
 * - `draw(ctx, w, h)` runs in CSS pixel space; the transform bakes in the DPR scale; h === w.
 */
