...
const meta: DemoMeta = {
  ...
  story: [
    ...
    },
    {
      ...
      body:
        "Honesty box: no 3D viewer - no STL/GLB exports of the Inventor models exist anywhere, so the gallery animates the render sequences instead (a viewer hook waits if they're ever exported). The VEX playgrounds are approximations drawn for this page; no VEX assets were copied. The perimeter program's block file didn't survive - its listing is reconstructed from the screenshot, labeled. The 'Wing simulator' image in the archive is NASA's FoilSim JS tool, not an Inventor render - shown separately, attributed. Feature stories are inferred from the part filenames. The sim and widgets were written with AI coding tools.",
    },
  ],
  sources: [
